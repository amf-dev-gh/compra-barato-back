package site.amf_dev.carrefour.controllers;
...
import site.amf_dev.carrefour.services.CarrefourScraperService;
...
public class CarrefourController {
	...
	private static final Logger logger = LoggerFactory.getLogger(CarrefourController.class);

	@Autowired
	private CarrefourScraperService scraperService;
	...
	public ResponseEntity<Map<String, Object>> healthCheck() {
		...
		health.put("service", "Carrefour Scraper");
