package site.amf_dev.mercadona.controllers;
...
import site.amf_dev.mercadona.services.MercadonaScraperService;
...
public class MercadonaController {
	...
	private static final Logger logger = LoggerFactory.getLogger(MercadonaController.class);

	@Autowired
	private MercadonaScraperService scraperService;
	...
	public ResponseEntity<Map<String, Object>> healthCheck() {
		...
		health.put("service", "Mercadona Scraper");
